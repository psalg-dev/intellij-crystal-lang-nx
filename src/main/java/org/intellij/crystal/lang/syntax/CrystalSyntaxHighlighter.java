...
public class CrystalSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey @NotNull [] getTokenHighlights(IElementType tokenType) {
        ...
        if (tokenType.equals(CrystalTypes.KEY)) {
            return KEY_KEYS;
        }
        if (tokenType.equals(CrystalTypes.VALUE)) {
            return VALUE_KEYS;
        }
        if (tokenType.equals(CrystalTypes.COMMENT)) {
            return COMMENT_KEYS;
        }
//        if (tokenType.equals(CrystalTypes.BAD_CHARACTER)) {
